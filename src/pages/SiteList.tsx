...
const SiteList = () => {
  ...
  const [currentSiteIdForCheckOwnership, setCurrentSiteIdForCheckOwnership] = React.useState<number | undefined>(undefined)
  ...
  return (
    <>
                ...
                <td>
                  {site.ownerProofStatus === OwnerProofStatus.UNVERIFIED ? (
                    <button
                      ...
                      onClick={() => {
                        setCurrentSiteIdForCheckOwnership(site.id)
      ...
      <SiteRegisterDialog id={currentSiteIdForCheckOwnership} />
